...
public class DriverMapsHelper implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {

    final String url = "http://www.klift.16mb.com/add_new_ride.php";
    final String urlGetRide = "http://www.klift.16mb.com/get_ride.php";
    String TAG = "RIDE";
    RequestQueue queue;
    ...
    private DriverMapsActivity activity;
    private GoogleMap map;

    private boolean firstLoad = false;
    private boolean srcSet = false, destSet = false, rideBooked = false;
    ...
    public void setActivity(DriverMapsActivity activity1) {
        activity = activity1;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (msg.equalsIgnoreCase("success")) {
                                ...
                                polylineStrings = js.getString("line");
    ...
    public void onMapReady(GoogleMap map1) {
        ...
        map.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                if (!rideBooked) {
                    if (srcMarker != marker && destMarker != marker && currLocMarker != marker) {
                        if (wayPoints.remove(marker)) {
                            marker.remove();
                            plotRoute();
                        }
                    }
        ...
        if (destSet) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (msg.equalsIgnoreCase("success")) {
                                    ...
                                    rideBooked = true;
                                    setRide();
                                    new Config().postToCheckPHPPage((WebView)activity.findViewById(R.id.webview),"rid",activity.rid);
                                } else {
                                    Toast.makeText(activity, "Error", Toast.LENGTH_LONG).show();
                                }
                            } catch (Exception e) {
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    map.put("route", routeDetails);
                    map.put("seats", seats);
                    map.put("line", polylineStrings);
                    return map;
                }
            };
            stringRequest.setTag(TAG);
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            if (lineOptions != null) {
                ...
                if (rideBooked) {
                    List<LatLng> arr = routeLines.getPoints();

                    src = arr.get(0);
                    new ReverseGeocodingTask(false).execute(src);

                    dest = arr.get(arr.size() - 1);
